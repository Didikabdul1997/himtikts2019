...
<head>
    ...
    <title>Kelola Akun | SMK Miftahul Hikmah</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Akun</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Kelola Akun</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
              ...
              <div class="col-md-6 col-md-6 col-sm-6 col-xs-12">
                  ...
                  <div class="hpanel">
                      <div class="panel-body">
                          <form action="../akun/simpan_akun.php" method="post" id="loginForm">
                              <input type="hidden" value="<?php echo $_SESSION['id_user']; ?>" name="id_user"/>
                              <div class="row">
                                  <div class="form-group col-lg-12">
                                      <label>Username</label>
                                      <input name="username" value="<?php echo $_SESSION['username'];?>" class="form-control" required="true">
                                  </div>
                                  ...
                                  <div class="form-group col-lg-6">
                                      ...
                                      <input name="rpassword" type="password" class="form-control" required="true">
                                  </div>
                                  <div class="form-group col-lg-12">
                                      <label>Nama Lengkap</label>
                                      <input name="nama" value="<?php echo $_SESSION['nama'];?>" class="form-control" required="true">
                                  </div>
                                  <div class="form-group col-lg-12 text-center">
                                    <button type="submit"class="btn btn-success loginbtn" value="Simpan">Simpan</button>
                                    <button type="reset" class="btn btn-default" value="Reset">Reset</button>
                                    <button type="cancel" class="btn btn-default" onclick="javascript:window.location='../bantu/home.php';"><a href="../bantu/home.php">Cancel</button></a>
                                  </div>
                              </div>
                          </form>
                      </div>
