...
<head>
    ...
    <title>Data Belum Hadir | Talkshow</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Data Belum Hadir</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Belum Hadir</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $siswa = mysqli_query($koneksi, "SELECT * from peserta where kehadiran='belum'");
                                                $nomer=1;
                                                foreach ($siswa as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['no']."</td>"; ?>
                                                        <td> 
                                                            <a class="btn btn-custon-three btn-danger" href="action_belum.php?id_peserta=<?php echo $row['id_peserta'];?>">Belum Hadir</a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $nomer++;
                                                }
