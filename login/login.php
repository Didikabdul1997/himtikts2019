    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-4 col-md-4 col-sm-4 col-xs-12">
                <div class="text-center m-b-md custom-login">
                    ...
                    <p>Aplikasi Admin Talkshow Teknologi</p>
                </div>
                <div class="hpanel">
        ...
        <div class="row">
            <div class="col-md-12 col-md-12 col-sm-12 col-xs-12 text-center">
                <p>Copyright &copy; 2019 <a href="https://colorlib.com/wp/templates/">HIMTIK UNUGIRI</a> All rights reserved.</p>
            </div>
        </div>
    </div>
