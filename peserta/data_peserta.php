...
<head>
    ...
    <title>Data Peserta | Talkshow</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Peserta</a> <span class="bread-slash">/</span>
                                            </li>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Peserta</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="nomer">NO</th>
                                                <th data-field="id_peserta" data-editable="true">ID Peserta</th>
                                                <th data-field="no_register" data-editable="true">No. Register</th>
                                                <th data-field="nama" data-editable="true">Nama</th>
                                                <th data-field="alamat" data-editable="true">Alamat</th>
												<th data-field="no" data-editable="true">No. Telp</th>
                                                <th data-field="kategori" data-editable="true">Kategori</th>
                                                <th data-field="bayar" data-editable="true">Bayar</th>
                                                <th data-field="kehadiran" data-editable="true">Kehadiran</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $siswa = mysqli_query($koneksi, "SELECT * from peserta");
                                                $nomer=1;
                                                foreach ($siswa as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['kehadiran']."</td>"; ?>
                                                        <td> 
                                                            <a href="edit_peserta.php?id_peserta=<?php echo $row['id_peserta'];?>&no_register=<?php echo $row['no_register'];?>&nama=<?php echo $row['nama'];?>&alamat=<?php echo $row['alamat'];?>&no=<?php echo $row['no'];?>&kategori=<?php echo $row['kategori'];?>&bayar=<?php echo $row['bayar'];?>&kehadiran=<?php echo $row['kehadiran'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_peserta.php?id_peserta=<?php echo $row['id_peserta'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $nomer++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright &copy; 2019 <a href="https://himtik.ti.unugiri.ac.id">HIMTIK Unugiri Bojonegoro</a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
