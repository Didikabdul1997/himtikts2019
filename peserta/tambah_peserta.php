...
<head>
    ...
    <title>Tambah Peserta | Talkshow</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Tambah Peserta</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <select class="form-control custom-select-value" name="kategori">
                                                                    <option value="Umum / Mahasiswa">Umum / Mahasiswa</option>
                                                                    <option value="Mahasiswa UNUGIRI">Mahasiswa UNUGIRI</option>
