...
<head>
    ...
    <title>Data Sudah Hadir | Talkshow</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Data Sudah Hadir</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Sudah Hadir</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $siswa = mysqli_query($koneksi, "SELECT * from peserta where kehadiran='sudah'");
                                                $nomer=1;
                                                foreach ($siswa as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['no']."</td>"; ?>
                                                        <td> 
                                                            <a class="btn btn-custon-three btn-success" href="action_sudah.php?id_peserta=<?php echo $row['id_peserta'];?>">Sudah Hadir</a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $nomer++;
                                                }
